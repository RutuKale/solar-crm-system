...
const BASE_URL =
  "https://6ad7eff4-8a86-42c3-952b-d15cf774e3e0-00-39bu2lnzlhl1y.picard.replit.dev/form/";
              ...
              <div className="p-5">
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  ...
                  <a href={waLink} target="_blank">
                    <div className="flex items-center gap-2 text-white text-sm font-semibold px-4 py-2.5 rounded-xl cursor-pointer hover:opacity-90 transition-opacity bg-secondary hover:bg-secondary-hover">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                        height="24"
                  ...
                  <Link to={`/customer-forms/order-form`} target="_blank">
                  ...
                  <button className="flex items-center gap-2 text-gray-700 text-sm font-semibold px-4 py-2.5 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 transition-colors">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                ...
                <div className="mt-3">
                  <button className="w-full flex items-center justify-between bg-gray-50 hover:bg-gray-100 border border-gray-100 rounded-xl px-4 py-2.5 transition-colors">
